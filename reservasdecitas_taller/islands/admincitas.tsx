      ...
      <div className="citas-list">
        {citasFiltradas.length > 0 ? (
          citasFiltradas.map((cita) => (
            <div className="cita-item" key={cita._id} data-estado={cita.estado}>
              ...
              <form method="POST">
                ...
                <button type="button" className="reprogramar-btn" onClick={() => setReprogramarId(cita._id)}>
                  Reprogramar
                </button>
              </form>
              ...
              {reprogramarId === cita._id && (
                <form method="POST" className="reprogramar-form">
                  ...
                  <label><strong>Nueva Fecha:</strong></label>
                  <input
                    type="date"
                    name="fecha"
                    value={nuevaFecha}
                    onInput={(e) => setNuevaFecha(e.currentTarget.value)}
                    required
                  />

                  <label><strong>Nueva Hora:</strong></label>
                  <input
                    type="time"
                    name="hora"
                    value={nuevaHora}
                    onInput={(e) => setNuevaHora(e.currentTarget.value)}
                    required
                  />

                  <button type="submit" name="estado" value="Reprogramada" className="reprogramar-btn">
